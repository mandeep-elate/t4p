...
/* deca63b1c2bd979db59a9312a787a007bf6b6fc0 */
class __TwigTemplate_759c2fb3fdf4a5e73d53985227868dbf extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "deca63b1c2bd979db59a9312a787a007bf6b6fc0", 2)->unwrap();
        // line 3
        echo \Breakdance\Lib\Vendor\Twig\Extension\Core\Functions\twig_call_macro($macros["macros"], "macro_atomV1IconCss", [\Breakdance\Lib\Vendor\Twig\Extension\Core\Functions\twig_get_attribute($this->env, $this->source, ($context["design"] ?? null), "icon", [], "any", false, false, false, 3), "bde-icon-icon", "%%SELECTOR%%", true, ($context["isBaseBreakpoint"] ?? null)], 3, $context, $this->getSourceContext());
        echo "
...
";
    ...
    {
        return "deca63b1c2bd979db59a9312a787a007bf6b6fc0";
    }
    ...
    {
        return new Source("", "deca63b1c2bd979db59a9312a787a007bf6b6fc0", "");
    }
}
