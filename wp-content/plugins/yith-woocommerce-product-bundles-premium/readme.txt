...
= 2.17.0 - Released on 10 June 2025 =

* New: support for WooCommerce 9.9
* Update: YITH plugin framework
* Tweak: include bundle_item as a parameter

= 2.16.0 - Released on 31 March 2025 =

* New: support for WordPress 6.8
* New: support for WooCommerce 9.8
* Tweak: save variation_id as int in the bundle product cart data

= 2.15.0 - Released on 25 February 2025 =

* New: support for WooCommerce 9.7
* Fix: correct bundle price in the cart when using the bundle's items price

= 2.14.0 - Released on 31 January 2025 =

* New: support for WooCommerce 9.6

= 2.13.0 - Released on 16 December 2024 =

* New: support for WooCommerce 9.5
* Update: YITH plugin framework

= 2.12.0 - Released on 18 November 2024 =

* New: support for WordPress 6.7
* New: support for WooCommerce 9.4
* New: support for WooCommerce mini-cart block
* Update: YITH plugin framework

= 2.11.0 - Released on 11 September 2024 =

* New: support for WooCommerce 9.3
* Update: YITH plugin framework

= 2.10.0 - Released on 07 August 2024 =

* New: support for WooCommerce 9.2
* Update: YITH plugin framework
* Fix: bundle items quantity calculation when reordering a previous product
* Fix: reorder bundle product with variable products

= 2.9.0 - Released on 11 July 2024 =

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Tweak: prevent fatal error if product does not exists
* Update: YITH plugin framework
* Dev: improved option selectors with the framework classes

= 2.8.0 - Released on 25 June 2024 =

* New: support for WooCommerce 9.0
* Tweak: improved integration with YITH Request a Quote
* Update: YITH plugin framework

= 2.7.0 - Released on 22 May 2024 =

* New: support for WooCommerce 8.9
* Update: YITH plugin framework
* Fix: int cast to avoid error

= 2.6.0 - Released on 11 April 2024 =

* New: support for WooCommerce 8.8
* Update: YITH plugin framework

= 2.5.0 - Released on 26 March 2024 =

* New: support for WordPress 6.5
* New: support for WooCommerce 8.7
* Update: YITH plugin framework
* Fix: issue with bundled items in cart in combination with WPML
* Fix: issue when translating cart via WPML
...
* Update: YITH plugin framework
* Fix: Hide bundle heading if all items are hidden

= 2.2.0 - Released on 19 December 2023 =

* New: support for WooCommerce 8.4
* Update: YITH plugin framework
* Dev: new filter 'yith_wcpb_per_item_pricing_option'

= 2.1.0 - Released on 19 November 2023 =

* New: support for WordPress 6.4
* New: support for WooCommerce 8.3
* Update: YITH plugin framework

= 2.0.1 - Released on 19 October 2023 =

* Fix: remove incorrect premium tab
...
* Tweak: improved support for YITH WooCommerce Name Your Price

= 1.29.0 - Released on 14 September 2023 =
...
* Dev: added yith_wcpb_show_link_on_bundle_order_item_title filter
* Dev: added yith_wcpb_show_link_on_bundle_cart_item_title filter
